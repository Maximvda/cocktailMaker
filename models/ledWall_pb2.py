...
# source: main/modules/protobuf/ledWall.proto
...
Upgrade = _reflection.GeneratedProtocolMessageType('Upgrade', (_message.Message,), dict(
  DESCRIPTOR = _UPGRADE,
  __module__ = 'main.modules.protobuf.ledWall_pb2'
